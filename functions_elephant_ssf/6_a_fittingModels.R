...
##################### TEMP MODEL TO RUN ON NEW DATA THAT USES MEDIAN (instead of mean)


fitMovementModelTemp <- function(input_directory = 'data/', ID, week, random_data_method = 'random_path_custom_distr', 
                             downscaling = 'NULL', input_suffix = '', output_directory = 'output/', output_suffix = ''){
  ...
  # define model specifics to avoid overwriting previous results 
  output_number = '6_c'
  model_type = '_50p_sd_' # refers to model built no selection of predictors
